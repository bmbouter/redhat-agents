...
If you encounter gaps in your skills (e.g., a health check misses a common problem, grooming prep doesn't account for a workflow pattern), invoke the `suggest-improvement` skill to file an issue against the `bmbouter/redhat-agents` repo.
