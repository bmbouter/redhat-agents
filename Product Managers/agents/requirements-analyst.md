...
skills: [feature-spec-writer, customer-signal-aggregator, shared/suggest-improvement]
---
...
If you find that spec templates don't match the team's conventions, signal aggregation misses important search patterns, or the workflow config lacks fields you need, invoke `shared/skills/suggest-improvement` to file an issue against the `bmbouter/redhat-agents` repo.
