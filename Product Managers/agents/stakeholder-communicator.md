...
tools: [jira-read]
skills: [decision-record, release-notes-drafter, stakeholder-brief, shared/suggest-improvement]
---
...
If you find that decision record templates miss important context, release notes formats don't match publishing requirements, or brief structures don't suit the audience, invoke `shared/skills/suggest-improvement` to file an issue against the `bmbouter/redhat-agents` repo.
