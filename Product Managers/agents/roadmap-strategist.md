...
tools: [jira-read]
skills: [roadmap-review, quarter-planning, roadmap-brief, shared/suggest-improvement]
---
...
If you find that roadmap analysis misses important patterns, quarter planning doesn't account for real-world constraints, or brief formats don't match audience needs, invoke `shared/skills/suggest-improvement` to file an issue against the `bmbouter/redhat-agents` repo.
